...
source /cvmfs/sw-nightlies.hsf.org/key4hep/setup.sh -r 2026-02-26
# LUXE compact
source /data/dust/user/wangyufe/luxegeo_v01/luxegeo/install/bin/thisluxegeo.sh
export LD_LIBRARY_PATH=/data/dust/user/wangyufe/luxegeo_v01/luxegeo/install/lib:$LD_LIBRARY_PATH
export DD4hep_LIBRARY_PATH=/data/dust/user/wangyufe/luxegeo_v01/luxegeo/install/lib64:$DD4hep_LIBRARY_PATH
