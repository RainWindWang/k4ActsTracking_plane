...
private:
  ...
  mutable k4FWCore::DataHandle<k4ActsTracking::SeedContainer> m_inSeeds{
      "TrackerSeeds", Gaudi::DataHandle::Reader, this};

  mutable k4FWCore::DataHandle<k4ActsTracking::MeasurementCollection> m_inMeas{
      "TrackerMeasurements", Gaudi::DataHandle::Reader, this};

  mutable k4FWCore::DataHandle<k4ActsTracking::InitialTrackParametersCollection> m_outParams{
