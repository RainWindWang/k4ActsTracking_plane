...
private:
  ...
  Gaudi::Property<std::string> m_outSeedsName{
      this, "OutputSeeds", "TrackerSeeds",
      "Output Acts::SeedContainer2"};

  /// Input: produced by digitization / EDM->ACTS converter
  mutable k4FWCore::DataHandle<k4ActsTracking::SpacePointCollection>
      m_inSpacePoints{m_inSpacePointsName, Gaudi::DataHandle::Reader, this};
